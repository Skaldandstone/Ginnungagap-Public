"""Write locked RealityScan camera priors for Bloom prototype turntables."""
...
CAPTURE_ROOT = ROOT / "Art/Characters/BloomEnemies/RealityScan"
...
def main():
    ...
    if not manifests:
        raise RuntimeError(f"No Bloom capture manifests found under {CAPTURE_ROOT}")
