...
# view with the HUD, from the opening shot on the sleeper to the title card; the test turns the
# engine's on-screen debug messages off itself while recording. Then
