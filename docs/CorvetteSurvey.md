...
Written by `Ginnungagap.Survey.CorvetteWalkthrough` on 2026-09-05 15:40 from `/Game/Assets/Maps/ShipProduction/L_Corvette_ThrustStack`. The character was driven on foot up the objective chain, back down it, and out to every side station; everything below was met on the way. Regenerate with the test, do not edit by hand.

## The walk

| # | Leg | Deck | Where | Path (m) | Walk (s) | Snags | Outcome |
|---|-----|------|-------|----------|----------|-------|---------|
| 1 | suit rack | 3 | (120, 1200, 960) | 2.9 | 1 | 0 | arrived, played |
...
| 7 | back to the breach patch | 7 | (450, 1707, 2621) | no path | 1 | 0 | arrived |
| 8 | back to the power station | 1 | (750, 1250, 41) | 147.3 | 25 | 0 | arrived |
| 9 | back to the workshop bench | 2 | (1300, 1400, 522) | 34.3 | 6 | 0 | arrived |
| 10 | back to the suit rack | 3 | (120, 1200, 960) | 44.0 | 8 | 0 | arrived |
| 11 | side: CVT_BatteryRecovery | 1 | (1410, 1200, 41) | 58.9 | 10 | 0 | arrived |
| 12 | side: CVT_ArmoryOverride | 4 | (93, 1600, 1331) | 75.5 | 13 | 0 | arrived |
...
| 18 | side: CVT_Door_CVT-D10-B | 10 | (1950, 1000, 3850) | 40.2 | 9 | 0 | arrived |
...
- Blocked: no complete path from (583, 1392, 3108) to back to the breach patch; nearest obstacle CVT_CorridorDebris (Fallen cable tray, 13.1 m from the path's end). A player cuts, squeezes or overrides here.
- Blocked: no complete path from (1239, 1474, 2248) to side: CVT_Door_CVT-D07; nearest obstacle door CVT_Door_CVT-D07 (2.6 m from the path's end). A player cuts, squeezes or overrides here.
...
- Snag: stuck at (962, 854, 2678) (deck 7) on the way to side: CVT_Door_CVT-D07, 1.6 m short, against nothing solid (a navmesh or path-following stall).
...
Figures at the end of the walk; the crew stands at (1172, 1501, 4398).
| Figure | Class | Deck | Where | Mesh | Attached to |
|--------|-------|------|-------|------|-------------|
| BP_PlayerFace010 | BP_PlayerFace01_C | 11 | (1172, 1501, 4308) | SKM_MHC_Face01_Ada_FaceMesh | BP_Player_Suit_Crew0 |
| BP_PlayerFace011 | BP_PlayerFace01_C | 11 | (1172, 1501, 4308) | SKM_MHC_Face01_Ada_FaceMesh | BP_Player_Suit_Crew0 |
